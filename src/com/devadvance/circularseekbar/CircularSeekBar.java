...
public class CircularSeekBar extends View {
	...
	private static final float DEFAULT_CIRCLE_Y_RADIUS = 20f;
	private static final float DEFAULT_POINTER_RADIUS = 5f;
	private static final float DEFAULT_POINTER_HALO_WIDTH = 3f;
	...
	private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(250, 250, 250, 255);
	private static final int DEFAULT_POINTER_COLOR = Color.argb(250, 250, 250, 255);
